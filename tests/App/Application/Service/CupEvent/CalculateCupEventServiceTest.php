...
class CalculateCupEventServiceTest extends TestCase
{
    ...
    public function it_fails_when_cup_event_not_found(): void
    {
        ...
        $command = new CalculateCupEvent('6deb7e98-b55d-4214-98ac-fc3a16e3ec6b', AuthFaker::fakeFootprintDto());
        $this->service->execute($command);
    }

    /** @test */
    public function it_fails_when_cup_cup_not_exist(): void
    {
    ...
    public function it_calculates_cup_event(): void
    {
        ...
        $command = new CalculateCupEvent('6deb7e98-b55d-4214-98ac-fc3a16e3ec6b', AuthFaker::fakeFootprintDto());
        $pointsDtoList = $this->service->execute($command);
